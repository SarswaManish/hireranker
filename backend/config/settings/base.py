...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='hireranker'),
...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=config('JWT_ACCESS_TOKEN_HOURS', default=24, cast=int)),
...
CELERY_TASK_ROUTES = {
    'tasks.resume_tasks.*': {'queue': 'resumes'},
...
MAX_IMPORT_FILE_SIZE = 10 * 1024 * 1024  # 10MB for CSV/XLSX
...
CANDIDATE_REVIEW_PRICE_CENTS = config('CANDIDATE_REVIEW_PRICE_CENTS', default=999, cast=int)

# AWS S3 (for production)
AWS_ACCESS_KEY_ID = config('AWS_ACCESS_KEY_ID', default='')
AWS_SECRET_ACCESS_KEY = config('AWS_SECRET_ACCESS_KEY', default='')
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='hireranker-media')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'HireRanker API',
    'DESCRIPTION': 'AI-powered candidate ranking and evaluation platform',
    'VERSION': '1.0.0',
